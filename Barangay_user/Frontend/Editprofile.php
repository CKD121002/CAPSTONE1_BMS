...
<div class="container">
 <aside class="sidebar" id="sidebar">
      ...
      <div class="sidebarcontent">
        <div class="sidebar-header">
          <div class="burgericon" onclick="toggleSidebar()">
            <i class="fa-solid fa-bars"></i>
          </div>
          <div class="logosidebar">
            <img src="../picture/Logo.png" alt="Barangay Logo" id="sidebarLogo">
        ...
        <form class="profileform" action="../Backend/update_profile.php" method="POST" enctype="multipart/form-data">
          <div class="profilepicsection">
            ...
            <div class="avatarcontainer">
              <img src="../picture/<?= htmlspecialchars($userData['profile_pic'] ?? 'UserIcon.png') ?>" alt="Profile Picture" class="profilepic">
            </div>
          ...
          <div class="passwordsection">
            ...
            <p class="formhint">Leave blank if you do not wish to change your password.</p>
            <div class="formsection">
              <div class="formgroup">

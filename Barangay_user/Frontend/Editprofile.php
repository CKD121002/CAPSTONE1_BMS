                ...
                <form class="profileform" action="../Backend/update_profile.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="profilepicsection">
                        <div class="avatar-wrapper">
                            <?php 
                                // Fallback logic: defaults to UserIcon.png if column is empty or null
                                $userPic = (!empty($userData['profile_pic'])) ? "../picture/" . $userData['profile_pic'] : "../picture/UserIcon.png";
                            ?>
                            <img src="<?= htmlspecialchars($userPic) ?>" alt="Profile" class="profilepic" id="profilePreview">
                        </div>
                        <div class="upload-controls">
                            <label for="file-upload" class="btnsubmit" style="display: inline-block; cursor: pointer; padding: 8px 20px; font-size: 13px;">
                                Choose Photo
                            </label>
...
<script>
// Function to update file name and preview image immediately

...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../NewCSS/Sidenav.css">
    <link rel="stylesheet" href="../NewCSS/Global.css">
    <link rel="stylesheet" href="../NewCSS/Footer.css">
    ...
    <div class="container">
      ...
      <main class="maincontent">
        <div class="contentwrapper">
          <h1>Request for Specialized IDs</h1>
<p>Select the ID type and provide your details.</p>

<form class="formsection" action="../Backend/submit_id.php" method="POST" enctype="multipart/form-data">
  <div class="formgroup">
  ...
  <div class="formgroup" style="flex: 100%">
    ...
    <input type="text" name="purpose" placeholder="e.g., Proof of eligibility, Travel, Job" required />

    <h3>Attachments</h3>
    <div class="uploadbox">
      <p>Upload any supporting documents (e.g., Birth Certificate, PWD ID, Solo Parent ID)</p>
